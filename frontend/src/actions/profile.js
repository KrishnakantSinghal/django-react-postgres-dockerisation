...
export const createProfile = (
  ...
  try {
    ...
    const res = await axios.post(`${API_BASE_URL}/profile`, body, config);
...
export const addExperience = (formData, history) => async dispatch => {
  try {
    ...
    const body = JSON.stringify(formData);
    const res = await axios.post(`${API_BASE_URL}/profile/experience`, body, config);
...
export const addEducation = (formData, history) => async dispatch => {
  try {
    ...
    const body = JSON.stringify(formData);
    const res = await axios.post(`${API_BASE_URL}/profile/education`, body, config);
...
export const deleteExperience = id => async dispatch => {
  try {
    const res = await axios.delete(`${API_BASE_URL}/profile/experience/${id}`);
...
export const deleteEducation = id => async dispatch => {
  try {
    const res = await axios.delete(`${API_BASE_URL}/profile/education/${id}`);
